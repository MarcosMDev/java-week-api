...
public class CursoService {
    ...
    public ResponseEntity<Curso> buscarCursoPeloId(Long id) {
        return cursoRepository.findById(id).map(curso -> ResponseEntity.ok().body(curso))
    ...
    public ResponseEntity<Curso> atualizarCursoPeloId(Curso curso, Long id) {
        return cursoRepository.findById(id)
                .map(cursoToUpdate -> {
                    ...
                    cursoToUpdate.setPerfilGithub(curso.getPerfilGithub());
    ...
    public ResponseEntity<Object> excluirCursoPeloId(Long id) {
        return cursoRepository.findById(id).map(cursoToDelete -> {
